data class Recipe(val title : String,
    ...
    fun main (args : Array<String>) {
        ...
        println("r1 hasjh code : ${r1.hashCode()}")
        println("r2 hasjh code : ${r2.hashCode()}")
        println("r3 hasjh code : ${r3.hashCode()}")

        val(vTitle, vMainIngredient,vIsvegetarian, vDifficulty) = r1
        println("vTitle is $vTitle and visVegetarian is $vIsvegetarian")
